...
export const VOICES = [
  { id: 'drx-vincenzo', name: 'DRX Vincenzo', team: 'DRX', img: `${A}58f2f870-3760-4136-b212-75b49d12af49`, hero: `${H}drx-vincenzo-hero.png`, thumb: `${T}vincenzo-thumb.png`, bg: '#242430' },
  { id: 'drx-ucal', name: 'DRX Ucal', team: 'DRX', img: `${A}1ded3ce6-fd94-4961-8699-861b7f993332`, hero: `${H}drx-ucal-hero.png`, thumb: `${T}ucal-thumb.png`, bg: '#2a2a34' },
  { id: 'drx-willer', name: 'DRX Willer', team: 'DRX', img: `${A}326fb409-5d8e-4c56-8554-dbe3c7d14038`, hero: `${H}drx-willer-hero.png`, thumb: `${T}willer-thumb.png`, bg: '#26222e' },
  { id: 'drx-andil', name: 'DRX Andil', team: 'DRX', img: `${A}bcfc4a75-9cbe-4afc-9967-d31d249cf965`, hero: `${H}drx-andil-hero.png`, thumb: `${T}andil-thumb.png`, bg: '#2b2b36' },
  { id: 'drx-lazyfeel', name: 'DRX Lazyfeel', team: 'DRX', img: `${A}6d419085-34a3-470b-8711-6ffc8e8683df`, hero: `${H}drx-lazyfeel-hero.png`, thumb: `${T}lazyfeel-thumb.png`, bg: '#26222e' },
  { id: 'drx-rich', name: 'DRX Rich', team: 'DRX', img: `${A}f588e805-c5af-47cc-949d-1f6e4e9e95ad`, hero: `${H}drx-rich-hero.png`, thumb: `${T}rich-thumb.png`, bg: '#2b2b36' },
  { id: 'doublelift', name: 'Doublelift', team: 'Creator', img: `${A}003c300c-6fb7-4cf3-9d2f-872b2c63afa3`, hero: `${H}doublelift-hero.png`, thumb: `${T}doublelift-thumb.png`, bg: '#1f1f27', videos: [
  ...
  { id: 'fanfan', name: 'fanfan', team: 'Creator', img: `${A}90169fa5-602b-49c7-b18d-89bcc2fb446d`, hero: `${H}fanfan-hero.png`, thumb: `${T}fanfan-thumb.png`, bg: '#1f1f27' },
  { id: 'typical-gamer', name: 'Typical Gamer', team: 'Creator', img: `${A}c564d3f6-ba86-47f4-8eb4-e4b99ca3374a`, hero: `${H}typical-gamer-hero.png`, thumb: `${T}typicalgamer-thumb.png`, bg: '#2e2535' },
...
// In-game 영상: 보이스별 전용 영상이 없으면 공용 인트로 영상으로 채움
